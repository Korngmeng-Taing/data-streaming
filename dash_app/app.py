...
from dash_app.callbacks import *  # noqa: E402, F401, F403
...
sidebar = html.Div(
    [
        ...
        dcc.Dropdown(id="timeframe-select",
                     ...
                     style={"color": "#000", "font-size": "0.85rem"}),
        html.Hr(style={"border-color": "#333"}),
        html.Label("Chart Type", style={"font-size": "0.85rem", "color": "#aaa", "margin-bottom": "4px"}),
        dcc.Dropdown(id="chart-type-select",
                     ...
                     style={"color": "#000", "font-size": "0.85rem"}),
        html.Label("Time Range", style={"font-size": "0.85rem", "color": "#aaa", "margin-bottom": "4px", "margin-top": "8px"}),
        dcc.Dropdown(id="time-range-select",
                     options=[
                         {"label": "All", "value": "all"},
                     ...
                     style={"color": "#000", "font-size": "0.85rem"}),
        html.Hr(style={"border-color": "#333"}),
        html.Label("Model", style={"font-size": "0.85rem", "color": "#aaa", "margin-bottom": "4px"}),
